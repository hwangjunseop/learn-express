...
app.set('port', process.env.PORT || 3000); // 앱의 포트를 성정 -> 환경 변수에 포트가 지정되어있지 않으면 3000번 포트를 사용
...
// 기본적으로 익스프레스가 에러를 처리하긴 하지만, 직접 에러처리 미들웨어를 연결해주는 것을 궈ㅗㄴ장
// 에러처리 미들웨어는 특별한 경우가 아니면 가장 애래에 위치함.
